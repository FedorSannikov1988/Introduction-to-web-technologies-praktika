...
//let number1 = Number.parseInt(prompt("Введите число #1"));

// const number1 = +prompt("Введите число #1");
// const number2 = +prompt("Введите число #2");

// //alert(`Сумма чисел #1 = ${number1} и #2 = ${number2} равна ${number1 + number2}`);

// function sum(a , b) {
//     return a + b;
// }

// alert(`Сумма чисел #1 = ${number1} и #2 = ${number2} равна ${sum(number1, number2)}`);
